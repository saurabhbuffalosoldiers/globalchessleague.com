...
<div class="gcl-homepage">
	...
	<section class="home-banner">
				...
				<div class="swiper home_banner_slider">
					<div class="swiper-wrapper text-center">
						<div class="swiper-slide">
							<a href="#"><img src="images/gcl-banner-1568x652.jpg" class="w-100 img-fluid"></a>
						</div>
					</div>
				</div>
			</div>
		...
		<section class="home-banner pt-4 pt-md-3 d-none">
			<div class="container">
		...
		<section class="home-banner pt-md-4" id="about">
			<div class="container pt-3 pt-md-5">
				<div class="gcl-heading text-center pt-3 pt-md-5">
					<h2 class="text-white">About The League</h2>
				</div>
					...
					<div class="row justify-content-center">
						<div class="col-md-6 pe-md-5">
							<div class="about-text text-white pb-3 pb-md-0 pt-md-0 pt-lg-5 pe-md-4">
								<p>Global Chess League (GCL) is the world’s first and largest official franchise chess league bringing fans together to witness the game in a never-seen-before avatar.  GCL is the only league in pro sports with a joint team format, featuring both men and women players going head-to-head, competing for the ultimate prize. The league aims to take the game to millions of fans with new and innovative formats, bringing in a new perspective to the game of chess.</p>
							    <p>FIDE and Tech Mahindra have joined hands to promote the game of chess through interactive technology-enabled platforms by leveraging next-gen technologies like 5G, AI, and VR, among others</p>
							</div>
							<a href="<?php 
							...
							<div class="col-md-6">
								<img src="images/Image-32-1.png" class ="img-fluid horse_img">
							</div>
						</div>
					</div>
				</div>
...
<!--formate			-->
	...
	<section class="home-banner" id="formate" >
		<div class="container-flud p-5">
			<div class="get-tickets">
				<div class="swiper home_banner_slider">
					<div class="swiper-wrapper text-center">
						<div class="swiper-slide">
							<a href="#"><img src="Format@4x (1).png" class="w-100 img-fluid"></a>
						</div>
					</div>
				</div>
			</div>
...
<section class="home-banner pt-4 pt-md-3" style="background-image: url('/wp-content/uploads/2023/02/Focus_Players_background.png'); background-repeat: no-repeat; background-size: cover; background-position: center;" id="contect">
			<div class="container">
					...
					<div class="swiper gcl_matches_slider mx-4 mx-md-5 ">
						<div class="swiper-wrapper text-center">
							<?php// while ($the_query->have_posts()) : $the_query->the_post(); ?>
								<div class="swiper-slide">
									<img src="images/Making-Moves-1-1.png" class="w-100 img-fluid">
								</div>
								<div class="swiper-slide">
									<img src="images/ark.png" class="w-100 img-fluid">
								</div>
								<div class="swiper-slide">
									<img src="images//Group-722.png" class="w-100 img-fluid">
								</div>
	...
	<!--</section>-->
			...
			<!-- Focus Player -->
				...
				<section class="focus-players pt-4" style="background-image: url('/wp-content/uploads/2023/02/Focus_Players_background.png'); background-repeat: no-repeat; background-size: cover; background-position: center;" id="player">
					<div class="container">
						<div class="gcl-heading text-center py-3 py-md-5">
							<h2 class="text-white">Key Players</h2>
						</div>
							...
							<div class="row px-lg-5">
									...
									<div class="col-md-6 col-lg-4 text-center">
										...
										<div class="gcl-player p-4">
											<a href="#" class="d-block"><img src="images/player_1.png" class="w-100 img-fluid"></a>
										</div>
										
										<div class="gcl-player p-4">
											<a href="#" class="d-block"><img src="images/player_2.png" class="w-100 img-fluid"></a>
										</div>
										
										<div class="gcl-player p-4">
											<a href="#" class="d-block"><img src="images/player_3.png" class="w-100 img-fluid"></a>
										</div>
										
										<div class="gcl-player p-4">
											<a href="#" class="d-block"><img src="images/player_4.png" class="w-100 img-fluid"></a>
										</div>
										
										<div class="gcl-player p-4">
											<a href="#" class="d-block"><img src="images/player_5.png" class="w-100 img-fluid"></a>
										</div>
										<div class="gcl-player p-4">
											<a href="#" class="d-block"><img src="images/player_6.png" class="w-100 img-fluid"></a>
										</div>
						...
						<div class="gcl-player swiper-container position-relative gcl-player-mobile">

					<div class="swiper focus_player_slider mx-4 mx-md-5">
						<div class="swiper-wrapper text-center">
						
								<div class="swiper-slide">
									<img src="images/player_1.png" class="w-100 img-fluid">
								</div>
									<div class="swiper-slide">
									<img src="images/player_2.png" class="w-100 img-fluid">
								</div>
									<div class="swiper-slide">
									<img src="images/player_3.pngg" class="w-100 img-fluid">
								</div>
									<div class="swiper-slide">
									<img src="images/player_4.png" class="w-100 img-fluid">
								</div>
									<div class="swiper-slide">
									<img src="images/player_5.png" class="w-100 img-fluid">
								</div>
									<div class="swiper-slide">
									<img src="images/player_6.png" class="w-100 img-fluid">
								</div>
				...
				<!-- Teams -->
					...
					<section class="teams pt-4" id="team">
						<div class="container">
							...
							<div class="gcl-teams position-relative team-player-desktop">

								<div class="row">
								
										<div class="col-6 col-md-4 col-lg-2 text-center pb-4 pb-lg-0">

											<div class="gcl-team">
												<a href="#" class="d-block"><img src="images/team1" class="w-100 img-fluid"></a>
											</div>
											<div class="gcl-team">
												<a href="#" class="d-block"><img src="images/team2" class="w-100 img-fluid"></a>
											</div>
											<div class="gcl-team">
												<a href="#" class="d-block"><img src="images/team3" class="w-100 img-fluid"></a>
											</div>
											<div class="gcl-team">
												<a href="#" class="d-block"><img src="images/team4" class="w-100 img-fluid"></a>
											</div>
											<div class="gcl-team">
												<a href="#" class="d-block"><img src="images/team5" class="w-100 img-fluid"></a>
											</div>
											<div class="gcl-team">
												<a href="#" class="d-block"><img src="images/team6" class="w-100 img-fluid"></a>
											</div>
							...
							<div class="gcl-teams swiper-container position-relative team-player-mobile">
					...
					<section class="sale-banner pt-0 pt-md-5 mt-4 mb-5 my-md-5 d-none">
						<div class="container">
									...
									<div class="gcl-highlights swiper-container position-relative">
										...
										<div class="swiper highlight_slider mx-4 mx-md-5">
											<div class="swiper-wrapper">
													<div class="swiper-slide">
														<a href="#" class="d-block text-decoration-none" data-lity>
							...
							<section class="highlights py-5" id="news">
								<div class="container">
									<div class="gcl-heading text-center pb-3 pb-md-5 pt-0 pt-md-4">
										<h2 class="text-white">News And Media</h2>
									</div>
									<div class="gcl-highlights swiper-container position-relative">
										...
										<div class="swiper post_slider mx-4 mx-md-5">
											<div class="swiper-wrapper">
													...
													<div class="post-slides">
														...
														<div style="background-image: url(images/Rectangle-500.png);" class="post_bg">
																
															</div>
															<div class="post-inner px-4 pt-4" style="background-color: #fff;">
																
																<p class="text-dark post-title pb-2 mb-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
																<p class="text-dark post-excerpt pb-2 mb-2" style="border-bottom: 2px solid red;">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
																<div class="post-meta text-dark d-flex align-items-center justify-content-between">
																	<p>News</p>
																	<p><a href="#" class="text-dark">Read More <i class="fa fa-arrow-right ms-2"></i></a></p>
																</div>
															</div>
													</div>
													</div>
													...
													<div class="post-slides">
														...
														<div style="background-image: url(images/Rectangle-485.png);" class="post_bg">
													...
													<div class="post-slides">
														...
														<div style="background-image: url(images/Rectangle-502.png);" class="post_bg">
					...
					<section class="gcl-partners">
						<div class="container">
							<!--<div class="gcl-heading text-center py-1 py-md-4">-->
							<!--	<h2 class="text-white"><?php the_field('partners'); ?></h2>-->
							<!--</div>-->
							<div class="gcl-all-partners position-relative">
								...
								<div class="row justify-content-center">
										...
										<div class="col-9 col-md-4 col-lg-2 text-center">
											...
											<div class="gcl-partner p-4">
												<p class="text-white">Presented By</p>
												<a href="#" class="d-block"><img src="/wp-content/uploads/2023/02/tech-mehandra.png" class=" img-fluid"></a>
											</div>
										...
										<div class="col-9 col-md-4 col-lg-2 text-center">
											...
											<div class="gcl-partner p-4">
												<p class="text-white">An Official Event By</p>
												<a href="#" class="d-block"><img src="/wp-content/uploads/2023/03/Group-706.png" class=" img-fluid"></a>
											</div>
