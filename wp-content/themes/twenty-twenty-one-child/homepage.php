								...
								<?php while ($the_query->have_posts()) : $the_query->the_post(); ?>
									<div class="col-md-6 col-lg-4 text-center">
										...
										<div class="gcl-player p-4">
											<a href="<?php echo get_the_permalink(); ?>" class="d-block"><img src="<?php echo get_the_post_thumbnail_url(); ?>" class="w-100 img-fluid"></a>
										</div>
								...
								<div class="row">
									<?php foreach ($get_all_teams as $team): $team_id = $team->term_id;?>
										<div class="col-6 col-md-4 col-lg-2 text-center pb-4 pb-lg-0">
											...
											<div class="gcl-team">
												<a href="<?php echo '/team/'.$team->slug.'/'; ?>" class="d-block"><img src="<?php echo get_field('team_image', $taxonomy.'_'.$team_id)['url']; ?>" class="w-100 img-fluid"></a>
											</div>
													...
													<div class="post-slides">
														...
														<div style="background-image: url(<?php echo get_the_post_thumbnail_url(); ?>);" class="post_bg">
															...
															<div class="post-inner px-4 pt-4" style="background-color: #fff;">
																...
																<p class="text-dark post-title pb-2 mb-2"><?php echo get_the_title(); ?></p>
																...
																<div class="post-meta text-dark d-flex align-items-center justify-content-between">
																	...
																	<p><a href="<?php echo get_the_permalink(); ?>" class="text-dark">Read More <i class="fa fa-arrow-right ms-2"></i></a></p>
																</div>
															</div>
													</div>
													</div>
